  ...
  return (
    <section className="relative w-full min-h-[80vh] md:min-h-screen overflow-hidden bg-white">
      <div className="absolute inset-0">
        ...
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(59,130,246,0.12),transparent_55%),radial-gradient(ellipse_at_bottom,rgba(236,72,153,0.1),transparent_55%)]" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-24 pb-16 sm:pt-28 md:pt-36 lg:pt-40">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-base sm:text-lg text-slate-600 max-w-2xl">
            A modern, glass‑morphic experience powered by an interactive 3D credit‑card scene. Built for analysts, funds, and power users.
          </p>
